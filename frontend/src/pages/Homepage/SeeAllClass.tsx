import { Card, Space, Image, Text, Grid, createStyles, Container, Group, Title } from "@mantine/core";
...
export default function SeeAllList() {
  ...
  //
  async function get() {
    let res = await fetch.get("/homepage/seeallclass");
    // console.log(res);
